...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      className={`${styles.paddingX} w-full flex items-center py-2 fixed top-0 z-20 transition-all duration-300 ${scrolled ? 'bg-dark-grey/95 backdrop-blur-sm shadow-lg' : 'bg-dark-grey'
        }`}
    >
